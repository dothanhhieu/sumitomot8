...
const BDKS = 'TIẾP TỤC';
const QS1 = 'Anh/chị cho biết về  đặc tính của các sản phẩm mình đang sử dụng (ít nhất đặc tính của 1 trong 6 sản phẩm)';
...
export default class ProductDetail extends Component {
  ...
  nextPage = async () => {
    ...
    this.statusFarmerParam()
    this.props.navigation.navigate('FutureProducts', this.outletParam)
  }
