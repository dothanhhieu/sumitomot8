...
const BDKS = 'TIẾP TỤC';
const QS1 = 'Anh/chị có dự tính tiếp tục sử dụng sản phẩm của Bayer trong mùa này không?';

export default class FutureProducts extends Component {
  ...
  nextPage = async () => {
    ...
    this.props.navigation.navigate('CultivatedArea', this.outletParam)
  }
