...
const camStore = 'Hình chụp mặt nông dân'
const camProduct = 'Hình nông dân cầm bao bì sản phẩm'
const camSurvey = 'Hình biên bản khảo sát'
const camSign = 'Hình DS ký nhận quà'
const camMascot = 'Hình nông dân nhận quà (đứng kế Mascot)'

class ImageFarmer extends Component {
    ...
    checkDataPushView() {
        ...
        this.props.navigation.navigate('FinalFarmer', paramPostInfo)
    }
